...
export default function Profile() {
  ...
  const handleRandomButtonClick = async () => {
    try {
      ...
      console.error("Random button click failed:", error);
    }
  }
  ...
  return (
    ...
    //   {randomItem && (
    //     <View>
    //       <Text>{randomItem.name}</Text>
    //       <Text>{randomItem.description}</Text>
    //       <Image source={{ uri: randomItem.imageUrl }} className="w-full h-full" />
    //     </View>
    //   )}
    // </SafeAreaView>
//   );
