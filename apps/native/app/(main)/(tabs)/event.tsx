      ...
      <View className="px-4 pt-[14%] backdrop-blur-sm">
        <View className="flex-row items-center justify-between mb-3">
          <View>
            ...
            <Text className="text-2xl font-bold text-white">Planner</Text>
          </View>
          <Pressable
            className="bg-white/5 rounded-full px-3 w-10 h-10 items-center justify-center"
            onPress={() => {
              Haptic.selectionAsync();
              router.push("/(main)/add-meeting");
            }}
          >
            <HugeiconsIcon icon={PlusSignIcon} color="white" size={20} />
          </Pressable>
        </View>

        {/* Segmented tabs */}
        <View className="bg-zinc-900 mb-3 rounded-2xl p-1 flex-row items-center w-full max-w-[380px] self-center">
          <Pressable
